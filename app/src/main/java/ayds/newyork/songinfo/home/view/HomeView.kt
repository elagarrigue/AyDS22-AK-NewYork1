...
import ayds.newyork.songinfo.moredetails.fulllogic.MoreDetailsWindow
...
class HomeViewActivity : AppCompatActivity(), HomeView {
    ...
    override fun navigateToOtherDetails(artistName: String) {
        val intent = Intent(this, MoreDetailsWindow::class.java)
        intent.putExtra(MoreDetailsWindow.ARTIST_NAME_EXTRA, artistName)
