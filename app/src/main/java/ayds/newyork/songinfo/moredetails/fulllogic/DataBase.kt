...
class DataBase(context: Context?) : SQLiteOpenHelper(context, "dictionary.db", null, 1) {
    ...
    companion object {
        fun testDateBase() {
            var connectionToDataBase: Connection? = null
            try {
                // create a database connection
                connectionToDataBase = DriverManager.getConnection("jdbc:sqlite:./dictionary.db")
                val statement = connectionToDataBase.createStatement()
